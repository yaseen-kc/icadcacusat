...
<head>
    ...
    <title>Call For Paper | ICA 2023</title>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb-text">
                        <h2>CALL FOR PAPPER</h2>
                        <div class="bt-option">
                            <a href="index.php">Home</a>
                            <span>Call For Papper</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        ...
                        <p class="f-para"><b>Dear Researcher,</b></p>
                        <p align="justify">On the behalf of ICA2023 organizing committee, I take this opportunity to invite you
                            to participate in this professionally enriching International Conference on Advances in
                            Intelligent Computing and Applications 2023. The ICA2023 covers six Technical
                            Tracks over multiple research areas. The conference will be embraced with keynotes
                            from International and National eminent speakers and workshop conducts. The
                            researchers will have the opportunity to present their own work during the conference.
                            A Call-for-paper is also enclosed for your perusal.</p>
                        </br>
                        <p>Dr. Vishnukumar S<br>
                            Associate Professor, DCA CUSAT</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="story-item">
                            ...
                            <div class="si-text">
                                ...
                                <ul>
                                    ...
                                    <li>● Human and usability factors in Web security & privacy</li>
                                    <li>● Measurement of online crime/underground economics</li>
                                    <li>● Tracking, profiling, and countermeasures against them</li>
                                    <li>● Measurement, analysis, and circumvention of Web censorship</li>
                                    <li>● Browser security</li>
                                    <li>● Authentication and authorization for Web-based services</li>
                                    <li>● Social network security and privacy</li>
                                    <li>● Transparency, trustworthiness and accountability of social networks</li>
                                    <li>● Abusive content such as online harassment, spam, and fake reviews</li>
                                    <li>● Privacy-enhancing technologies for the Web</li>
                                    <li>● Legal, ethical, policy issues of Web security and privacy</li>
                                    ...
                                    <li>● Trust models</li>
                                    <li>● Artificial Intelligence in the context of web security</li>
                                </ul>
                            </div>
                        </div>
                        <div class="story-item">
                            <h2>TRACK 3</h2>
                            <div class="si-text">
                                <h4>Cloud, Parallel, Distributed and High Performance Computing</h4>
                                <ul>
                        ...
                        <div class="story-item">
                            ...
                            <div class="si-text">
                                ...
                                <ul>
                                    ...
                                    <li>● Interfacing of Temperature, Humidity, Motion, Light and Gas Sensor </li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        ...
                        <p class="f-para" align="justify">Prospective authors are invited to submit the manuscript not exceeding six pages, with double column IEEE conference format. The manuscript templates for the conference (Microsoft Word or LaTeX) can be downloaded from <a href="https://www.ieee.org/conferences/publishing/templates.html">Here</a></p>
                        <!-- <a href="https://www.ieee.org/conferences/publishing/templates.html" class="primary-btn">Download</a> -->
                        </br>
                        <p class="f-para" align="justify">All the submitted manuscript will be screened through a plagiarism detection process. Submissions that exceed 20% similarity shall not be considered for the review and subsequent processes. All papers that confirm to the submission guidelines will be peer-reviewed by members of the technical program committee. Submissions will be evaluated on the basis of originality, contribution, soundness, evaluation, quality of presentation, and appropriate comparison to the state of the art. The manuscript can be submitted through Microsoft Conference Management System using the Link:</p>
                        </br>
                        <p class="f-para" align="justify">The submitted manuscript should not be published or under review in any journals/magazines or conference proceedings, and best paper will be awarded in each track.</p>
                        <a href=" https://easychair.org/conferences/?conf=ica2023" class="primary-btn">Submit Paper</a><!--https://www.ieee.org/conferences/publishing/templates.html-->
                    </div>
                </div>
            </div>
        </div>
